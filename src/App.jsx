      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div style={{ background: "#fff", borderRadius: 12, border: "1px solid #e8e4df", padding: 32 }}>
          <p style={{ fontSize: 14, color: "#8a8278", marginBottom: 16 }}>
            {view === "scorecard" && "The full Scorecard app will render here with access to all competitor data."}
            {view === "xray" && "The full X-Ray Vision app will render here with access to all competitor data."}
            {view === "content" && "The full Content Engine app will render here with access to all competitor data."}
          </p>
